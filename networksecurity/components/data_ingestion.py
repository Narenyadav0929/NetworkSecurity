...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        """
        try:
            logging.info("Connecting and importing data from MongoDB")
            ...
            logging.info("Sucessfully load the data and stored in dataframe")
            return df
    ...
    def export_data_to_feature_store(self,dataframe:pd.DataFrame):
        ...
        logging.info("Raw data stored in Feature store locally")
        return dataframe
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            ...
            os.makedirs(dir_path, exist_ok=True)
            logging.info("Exporting train and test data for model tranning")

            train_set.to_csv(self.data_ingestion_config.training_file_path, index=False, header=True)
            test_set.to_csv(self.data_ingestion_config.testing_file_path, index=False, header=True)
            logging.info("Exported the train & test data")
