...
class TraningPipeline:
    ...
    def start_data_ingetion(self):
        try:    
            ...
            data_ingestion_artifact = data_ingestion.initiate_data_injetion()
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            data_validation = DataValidation(data_injetion_artifact=data_ingestion_artifact,
    ...
    def start_data_transformation(self,data_validation_artifacts:DataValidationArtifact):
        try:
            ...
            data_transformation = DataTransformation(data_validation_artifact=data_validation_artifacts,
    ...
    def run_pipeline(self):
        try:
            ...
            logging.info('Data saved to S3 bucket sucessfully')
            return model_trainer_artifact
